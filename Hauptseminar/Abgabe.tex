...
\subsection{Fazit}
Seit seiner Entwicklung im Jahre 1979 hat sich am Prinzip der RSA Verschlüsselung nichts geändert. Mit dem Fortschritt der Technik ist der RSA eine gängige Art der sicheren Kommunikation geworden. Aktuelle Rechner können das Schlüsselpaar der asymmetrischen Verschlüsselung, die zur Ver- und Entschlüsselung von Nachrichten zwei voneinander verschiedene Schlüssel verwendet, nativ berechnen. Doch so leicht es auch ist, den Algorithmus mathematisch zu bestimmen, so beängstigend ist es, ihn hardware-spezifisch umzusetzen. Wie im laufe der vorliegenden Arbeit gezeigt wurde, ist die mathematische Herleitung einfach zu verstehen, doch durch die Anforderungen an die Operanden, groß, voneinander verschieden, zufällig und prim gewinnt die Methodik an Schwierigkeit. Vor allem bei dem Versuch, diese ohne genaue Kenntnisse der Operatoren zu ermitteln. Doch eben diese Faktoren, die die Sicherheit gewährleisten, sind hardwarespezifisch sehr aufwendig zu realisieren. Sowohl im Hinblick auf die Berechnungszeit und der Kosten des Systems müssen vor der Implementierung auch mögliche Angriffe durchdacht werden, welche auf das Überwachen der Hardwareressourcen ausgelegt sind.\\ Der RSA Algorithmus verändert sich ständig durch kleine Änderungen weiter. Wie zum Beispiel die Verwendung einer Fermat Primzahl als Verschlüsselungs-Exponenten. Andere Änderungen wie den Ausschluss der side-channel Attacken bedürfen etwaiger Änderungen, die eventuell großen Einfluss auf die Komplexität, den Platz oder den Stromverbrauch des Systems haben. Wie bei jeder anderen Verschlüsselung ist das Ziel der Ausschluss derer, die sie knacken wollen um die sichere Kommunikation zwischen zwei Partnern zu gewährleisten. 
